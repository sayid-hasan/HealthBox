...
const SwipperBtns = () => {
  ...
  return (
    <>
      <div className="swiper-btns absolute md:left-5 z-10 md:bottom-5 bottom-2 left-3 lg:left-[9rem] text-center  text-PrimaryColor flex text-3xl justify-center items-center gap-4  ">
        <button
